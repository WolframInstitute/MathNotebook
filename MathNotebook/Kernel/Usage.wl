...
ImportLaTeXDocument::usage = "ImportLaTeXDocument[\"file.tex\"] reads a LaTeX paper as a Notebook: sectioning and theorem-like environments become cells of the corresponding style, mathematics is converted, labels become cell tags, cross-references and citations become live buttons, the entries of the paper's .bib become Reference cells, and everything else is carried verbatim so that ExportLaTeXDocument returns the source unchanged."
