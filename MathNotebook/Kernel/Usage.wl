...
SetContentWidth::usage = "SetContentWidth[width] lays the content of the input notebook out in a column centered in the page, occupying the given fraction of it, on screen and in print.\nSetContentWidth[notebook, width] sets the given notebook.\nSetContentWidth[notebook, Automatic] removes the override."
