...
SetContentWidth::usage = "SetContentWidth[width] lays the content of the input notebook out in a column of the given width in points, centered in the page, the same measure on screen and on paper.\nSetContentWidth[notebook, width] sets the given notebook.\nSetContentWidth[notebook, Full] leaves the column unconstrained.\nSetContentWidth[notebook, Automatic] removes the override."
