% LaTeX counterpart of the AMSArticle stylesheet sample.
...
\author{MathNotebook}
\date{Set with the \texttt{amsart} class.}

\begin{document}

\begin{abstract}
The same document as the AMSArticle notebook sample, typeset in LaTeX, so the
